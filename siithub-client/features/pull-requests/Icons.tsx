...
export const PrOpenIcon: FC<IconProps> = ({ width = 16, height = 16, color = "green" }) => (
...
export const PrMergedIcon: FC<IconProps> = ({ width = 16, height = 16, color = "purple" }) => (
  <svg viewBox={`0 0 ${width} ${height}`} width={width} height={height}>
    <path
      fillRule="evenodd"
      style={{ fill: color }}
...
export const PrClosedIcon: FC<IconProps> = ({ width = 16, height = 16, color = "red" }) => (
  <svg viewBox={`0 0 ${width} ${height}`} width={width} height={height}>
    <path
      fillRule="evenodd"
      style={{ fill: color }}
